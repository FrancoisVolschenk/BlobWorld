...
class Brain:
    ...
    def from_genome(genome, input_size, hidden_size, n_hidden, output_size):
        ...
        brain.input_weights = pop(hidden_size * input_size).reshape((hidden_size, input_size))
        ...
        brain.output_weights = pop(output_size * hidden_size).reshape((output_size, hidden_size))
...
class NeuralBlob(Blob):
    ...
    def __init__(self, x = 0, y = 0, width = 10, height = 10, speed = 0.5, bearing = 0, brain = None):
        ...
        self.colour = (0, 255, 0)
        self.brain = Brain(input_size=5, hidden_size=5, n_hidden=2, output_size=2) if brain is None else Brain.from_genome(brain, input_size=5, hidden_size=5, n_hidden=2, output_size=2)
